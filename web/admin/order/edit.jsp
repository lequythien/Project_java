                                ...
                                <form action="EditOrderServlet" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="status" class="form-control">
                                            ...
                                            <option <c:if test="${order.status == 'failed'}">selected</c:if> value="failed">failed</option>
                                            <option <c:if test="${order.status == 'delivered'}">selected</c:if> value="delivered">delivered</option>
                                            </select>
                                        </div>
