                                ...
                                <div class="sidebar-widget wow fadeInUp">
                                    ...
                                    <div class="sidebar-widget-body">
                                        <div class="accordion">
                                                ...
                                                <div class="accordion-body collapse" id="collapseOne" style="height: 0px;">
                                                    <div class="accordion-inner">
                                                        <ul>
                                                            ...
                                                            <li><a href="CategoryServlet?categoryId=2">Quần nam</a></li>
                                                        </ul>
                                                    </div>
                                                    <!-- /.accordion-inner --> 
                                                </div>
                                            ...
                                            <div class="accordion-group">
                                                <div class="accordion-heading"> <a href="#collapseTwo" data-toggle="collapse" class="accordion-toggle collapsed"> Nữ </a> </div>
                                                <!-- /.accordion-heading -->
                                                <div class="accordion-body collapse" id="collapseTwo" style="height: 0px;">
                                                    <div class="accordion-inner">
                                                        <ul>
                                                            <li><a href="CategoryServlet?categoryId=3">Áo nữ</a></li>
                                                            <li><a href="CategoryServlet?categoryId=4">Quần nữ</a></li>
                                                        </ul>
                                                    </div>
                                                    <!-- /.accordion-inner --> 
                                                </div>
                            ...
                            <div class="item">
                                ...
                                <div class="container-fluid">
                                    <div class="caption vertical-top text-left">
                                        <div class="big-text"> LQT Shop </div>
